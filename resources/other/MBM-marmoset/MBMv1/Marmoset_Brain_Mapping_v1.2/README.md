### MBM_Marmoset_Atlas_v1 (focus on cortical parcellation)
...
# Release v1.2 updates
Changed the atlas file name prefix to "MBM_" (Marmoset Bain Mapping)
Corrected an typo error of abbre. in "MBM_labels_cortex_and_subcortical.xlsx" (MBM_cortex_vPaxinos area 56 to "AuCL")

# Release v1.1 updates
This is a major update of our previous (first) release (v0.02) of the MBM marmoset Brain atlas. Updates include:
...
5) We added a folder to include the results of studies that used the MBM marmoset Brain atlas (V1).


# Release v1.1 files
MBM_cortex_vL_150um.nii.gz -- the location-based parcellation (13 cortical regions)

MBM_cortex_vM_150um.nii.gz -- the MRI-based parcellation (54 cortical regions)

MBM_cortex_vH_150um.nii.gz -- the connectivity-based parcellation (103 cortical regions)

MBM_cortex_vPaxinos_150um.nii.gz -- the Paxinos brain atlas parcellation in MBM MRI template space

MBM_subcortical_beta_150um.nii.gz -- the subcortical ROIs, this is a beta version.

MBM_mask_150um.nii.gz -- whole brain mask

MBM_mask_left_150um.nii.gz -- left brain mask

MBM_mask_right_150um.nii.gz -- right brain mask
...
MBM_labels_cortex_and_subcortical.xlsx -- label file for the three MBM atlases and Paxinos atlas parcellations
...
Results_On_The_Template_Space -- Studies that used the MBM Marmoset Brain atlas V1. Result files are in the template space.


# Note:

If you have questions about the atlas, please contact Dr. Cirong Liu (cirong.liu@nih.gov)
